...
export function MarketingFooter() {
  ...
  return (
    <footer className="bg-[#111318] text-[#E2E4E9]">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-12">
        <div className="grid grid-cols-1 gap-14 py-16 lg:grid-cols-12 lg:gap-10">
          ...
          <div className="flex flex-col gap-7 lg:col-span-4">
            ...
            <p className="max-w-[280px] text-[15px] leading-relaxed text-[#9AA0AE]">
              {t("description")}
            </p>
            ...
            <Link
              href="/produkte"
              className="group inline-flex w-fit items-center gap-2 text-[13px] font-bold uppercase tracking-[0.2em] text-[#C8A96E] transition-opacity hover:opacity-70"
            >
              {t("toProducts")}
          ...
          {/* Nav columns */}
          <div className="grid grid-cols-2 gap-10 sm:grid-cols-3 lg:col-span-4 lg:gap-8">
            {/* Seiten */}
            <div>
              <p className="mb-5 text-[11px] font-black uppercase tracking-[0.25em] text-[#C8A96E]">
                Seiten
              </p>
              <ul className="space-y-3">
                {[
                  { href: "/",          label: "Home" },
                  { href: "/produkte",  label: t("toProducts") },
                  { href: "/news",      label: t("news") },
                  { href: "/kontakt",   label: t("kontakt") },
                ].map(({ href, label }) => (
                  <li key={href}>
                    <Link href={href as "/"} className="text-[15px] text-[#9AA0AE] transition-colors hover:text-[#E2E4E9]">
                      {label}
                    </Link>
                  </li>
                ))}
              ...
              <ul className="space-y-3">
                <li>
                  <a href="https://maps.google.com/?q=Romstraße+31/A,+Meran" target="_blank" rel="noopener noreferrer"
                    className="text-[15px] text-[#9AA0AE] transition-colors hover:text-[#E2E4E9]">
                    {t("adresse")}
                  </a>
                </li>
                <li>
                  <a href="tel:+390473232755" className="text-[15px] text-[#9AA0AE] transition-colors hover:text-[#E2E4E9]">
                    {t("telefon")}
                  </a>
                </li>
                <li>
                  <a href="mailto:info@brugnara.bz.it" className="text-[15px] text-[#9AA0AE] transition-colors hover:text-[#E2E4E9]">
                    {t("email")}
                  </a>
                </li>
              </ul>
            ...
            <div className="space-y-3">
              {STATIC_OEFFNUNGSZEITEN.map((zeit) => (
                <div key={zeit.tag} className="flex items-center justify-between gap-4">
                  <span className="text-[15px] font-semibold text-[#E2E4E9]">
                    {t(zeit.tag)}
                  </span>
                  {zeit.geschlossen ? (
                    ...
                    <div className="flex items-center gap-3 tabular-nums text-[14px] text-[#9AA0AE]">
        ...
        <div className="flex flex-col gap-4 border-t border-[#2A2D35] py-6 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-[13px] text-[#4B5060]">
          ...
          <button
            ...
            className="group inline-flex items-center gap-2 text-[12px] font-bold uppercase tracking-[0.2em] text-[#4B5060] transition-colors hover:text-[#E2E4E9]"
          >
