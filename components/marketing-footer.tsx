        ...
        <div className="grid grid-cols-1 gap-14 py-16 lg:grid-cols-12 lg:gap-10">
          ...
          <div className="grid grid-cols-1 gap-10 lg:col-span-4 lg:gap-8">
            ...
            <div className="text-center">
              <p className="mb-5 text-[11px] font-black uppercase tracking-[0.25em] text-[#264D68] text-center">
                {t("kontakt")}
              </p>
...
<div className="lg:col-span-4 max-w-xs mx-auto lg:mx-0 lg:max-w-none text-center lg:text-left">
  ...
  <div className="space-y-4">
    {STATIC_OEFFNUNGSZEITEN.map((zeit) => (
      <div key={zeit.tag} className="flex items-center justify-between gap-15">
        ...
        {/* ── Bottom bar ── */}
        <div className="flex flex-col gap-4 border-t border-[#2A2D35] py-6 items-center text-center sm:grid sm:grid-cols-3 sm:items-center sm:text-left">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 text-[13px] text-[#264D68]">
