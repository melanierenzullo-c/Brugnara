...
export function MarketingFooter() {
  ...
  return (
    <footer className="bg-[#F6F7FB] text-[#333333]">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-12">
        <div className="grid grid-cols-1 gap-14 py-16 lg:grid-cols-12 lg:gap-10">
          ...
          <div className="flex flex-col gap-7 lg:col-span-4">
            ...
            <p className="max-w-[280px] text-[15px] leading-relaxed text-[#333333]">
              {t("description")}
            </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={href}>
                    <Link href={href as "/"} className="text-[15px] text-[#333333] transition-colors hover:text-[#E2E4E9]">
                      {label}
                    </Link>
                  </li>
                ))}
              ...
              <ul className="space-y-3">
                <li>
                  <a href="https://maps.google.com/?q=Romstraße+31/A,+Meran" target="_blank" rel="noopener noreferrer"
                    className="text-[15px] text-[#333333] transition-colors hover:text-[#E2E4E9]">
                    {t("adresse")}
                  </a>
                </li>
                <li>
